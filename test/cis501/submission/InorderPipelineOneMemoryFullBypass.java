...
public class InorderPipelineOneMemoryFullBypass {
    private static IInorderPipeline sim_full;
    ...
    @Before
    public void setup() {
        sim_full = new InorderPipeline(1/*no add'l memory latency*/, Bypass.FULL_BYPASS);
    }
    ...
    public void test1Uop() {
        ...
        sim_full.run(insns);
        assertEquals(1, sim_full.getInsns());
        // 12345678
        // fdxmw|
        assertEquals(6, sim_full.getCycles());
    }
    ...
    public void testManyUops() {
        ...
        sim_full.run(insns);
        assertEquals(COUNT, sim_full.getInsns());
        assertEquals(5 + COUNT, sim_full.getCycles());
    }
    ...
    public void test1MemUop() {
        ...
        // 123456789abcdef
        // fdxmw|
        assertEquals(7, sim_full.getCycles());
    }
    ...
    public void testManyMemUops() {
        ...
        sim_full.run(insns);
        assertEquals(COUNT, sim_full.getInsns());
        assertEquals(25, sim_full.getCycles());
    }
    ...
    public void testLoadUse1() {
        ...
        sim_full.run(insns);
        assertEquals(2, sim_full.getInsns());
        // 123456789abcdef
        // fdxm.w  |
        //  fd..xmw|
        assertEquals(9, sim_full.getCycles());
    }
    ...
    public void testLoadUseStoreAddress() {
        ...
        assertEquals(expected, sim_full.getCycles());
    }
