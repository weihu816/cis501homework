...
public interface IOOOLoadStoreQueue {
     ...
     * little-endian byte order. E.g., if memory addresses 0-3 contain values 0x00, 0x11, 0x22,
     * 0x33, respectively, then a 4-byte load from address 0x0 will return 0x00112233
     */
     ...
     *                little-endian byte order. E.g., if you want to write to memory addresses 0-3
